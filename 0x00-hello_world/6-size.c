...
int main(void)
{
	...
	printf("Size of an int %lu: ", (unsigned int)sizeof(i));
	printf("SIze of a long int %lu: ", (unsigned int)sizeof(ln));
	printf("Size of a long long int %lu: ", (unsigned long)sizeof(lln));
